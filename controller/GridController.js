...
(function () {
    ...
    function GridController($scope) {
        ...
        self.gridOptions = {
            ...
            columnDefs: [
                { field: 'Name', displayName: '{{"Grid_Name"|translate}}', headerCellFilter: 'translate'},
                {name: '性別', field: 'Sex'},
                {name: '居住地', field: 'Address.City'},
                {
                    name: '顯示細節',
                    cellTemplate: '<button class="btn-primary" ng-click="grid.appScope.showMe(row)">Show</button>'
                }
            ],
            data: [
                {
